...
def parse_cve_entries(vulnerabilities: list) -> list:
    ...
    for vuln in vulnerabilities:
        ...
        results.append((cve_id, cve_data, structured_affected, structured_cpes, structured_weaknesses))
...
def upsert_cve(conn, cve_id: str, cve_data: dict, affected_entries: list, cpe_entries: list, weakness_entries: list) -> None:
...
def main() -> None:
    ...
    while not shutdown_requested:
        ...
        for cve_id, cve_data, affected_entries, cpe_entries, weakness_entries in entries:
            if shutdown_requested:
            ...
            try:
                upsert_cve(conn, cve_id, cve_data, affected_entries, cpe_entries, weakness_entries)
                page_cve_success += 1
